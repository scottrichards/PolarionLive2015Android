...
public class SignupFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mUsernameField = (EditText) mView.findViewById(R.id.register_username);
        mPasswordField = (EditText) mView.findViewById(R.id.register_password);
        mEMailField = (EditText) mView.findViewById(R.id.email);
        mCompanyField= (EditText) mView.findViewById(R.id.company);
        mTitleField = (EditText) mView.findViewById(R.id.title);
        mErrorField = (TextView) mView.findViewById(R.id.error_messages);
        mFullNameField = (EditText) mView.findViewById(R.id.fullName);

        Button onSignUpButton = (Button)mView.findViewById(R.id.sign_up);
