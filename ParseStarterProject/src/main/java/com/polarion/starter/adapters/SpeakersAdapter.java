...
import com.polarion.starter.model.ImageCache;
...
public class SpeakersAdapter extends ArrayAdapter<Speaker> {
    ...
    public SpeakersAdapter(Context context, List<Speaker> objects) {
        super(context, com.polarion.starter.R.layout.speaker_row_item, objects);
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        if(convertView == null){
            ...
            convertView = mLayoutInflater.inflate(com.polarion.starter.R.layout.speaker_row_item, null);
        }
        mConvertView = convertView;

        Speaker speaker= mSpeakers.get(position);

        TextView nameView = (TextView) convertView.findViewById(com.polarion.starter.R.id.name);
        nameView.setText(speaker.getName());

        TextView companyView = (TextView) convertView.findViewById(com.polarion.starter.R.id.company);
        companyView.setText(speaker.getCompany());

        TextView titleView = (TextView) convertView.findViewById(com.polarion.starter.R.id.title);
        titleView.setText(speaker.getTitle());

        TextView bioView = (TextView) convertView.findViewById(com.polarion.starter.R.id.bio);
...
//                if (imageCache == null) {   // if it has not been entered in hash table then add it
                    ImageView headshotView = (ImageView) mConvertView.findViewById(com.polarion.starter.R.id.headshot);
                ...
                imageFile.getDataInBackground(new GetDataCallback() {
                    ...
                    public void done(byte[] data, ParseException e) {
                        ...
                        if (localImageCache != null) {
                            ...
                            ImageView headshotView = (ImageView) localImageCache.convertView.findViewById(com.polarion.starter.R.id.headshot);
