...
import com.polarion.starter.StarterApplication;
...
public class AgendaDetailsActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView descriptionView = (TextView)findViewById(com.polarion.starter.R.id.sessionDescription);
        ...
        final RatingBar presenterBar = (RatingBar)findViewById(com.polarion.starter.R.id.presenterBarGrid);
