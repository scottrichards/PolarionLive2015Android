...
public class MapsActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.polarion.starter.R.layout.activity_maps);
        setUpMapIfNeeded();
    }
    ...
    private void setUpMapIfNeeded() {
        ...
        if (mMap == null) {
            ...
            mMap = ((SupportMapFragment) getSupportFragmentManager().findFragmentById(com.polarion.starter.R.id.map))
                    .getMap();
