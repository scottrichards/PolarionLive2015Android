...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView =  inflater.inflate(com.polarion.starter.R.layout.fragment_login, container, false);

        mCurrentUser = ParseUser.getCurrentUser();
        mLogInView = (LinearLayout) mView.findViewById(com.polarion.starter.R.id.logInView);
        mLoggedInView = (LinearLayout) mView.findViewById(com.polarion.starter.R.id.loggedInView);
        if (mCurrentUser == null) {
            mLoggedInView.setVisibility(LinearLayout.GONE);
            mLogInView.setVisibility(View.VISIBLE);
            mLogInView.invalidate();
            mLoggedInView.invalidate();
            mUsernameField = (EditText) mView.findViewById(com.polarion.starter.R.id.login_username);
            mPasswordField = (EditText) mView.findViewById(com.polarion.starter.R.id.login_password);
            ...
            mLogInView.invalidate();
            mLoggedInView.invalidate();
            mLoggedInField = (TextView) mView.findViewById(com.polarion.starter.R.id.loggedinMessage);
            String loggedInString = "Logged in as: " + mCurrentUser.getUsername();
            mLoggedInField.setText(loggedInString);
        }
        Button button = (Button)mView.findViewById(com.polarion.starter.R.id.sign_in);
...
//                signIn();
                ...
                if (userName.length() == 0 || password.length() == 0) {
                    mErrorField.setText(getResources().getString(com.polarion.starter.R.string.enter_username));
                    displayAlert(com.polarion.starter.R.string.enter_username);
                } else {
        ...
        Button logoutButton = (Button)mView.findViewById(com.polarion.starter.R.id.logout);
        ...
        Button signupButton = (Button)mView.findViewById(com.polarion.starter.R.id.registerButton);
