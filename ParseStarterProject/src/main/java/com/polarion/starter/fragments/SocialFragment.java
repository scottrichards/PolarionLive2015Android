...
public class SocialFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView =  inflater.inflate(com.polarion.starter.R.layout.fragment_social, container, false);
        Button postButton = (Button)mView.findViewById(com.polarion.starter.R.id.postButton);
        postButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText editText = (EditText)mView.findViewById(com.polarion.starter.R.id.editText);
